			...
			<div id="foot" style="width:735px;margin-left: 30px;">
				...
				<div id="btn" style="margin-top:0px; height:50px;">
					<ul style="margin-bottom:0px;margin-top:0px;">
							...
							<li><a href="${pageContext.request.contextPath}/front?method=menu&currentPage=1">首页</a></li>
						
							<li><a href="${pageContext.request.contextPath}/front?method=menu&currentPage=${pageBean.currentPage-1}">上一页</a></li>
							
							<li><a href="${pageContext.request.contextPath}/front?method=menu&currentPage=${pageBean.currentPage+1}">下一页</a></li>
							
							<li><a href="${pageContext.request.contextPath}/front?method=menu&currentPage=${pageBean.totalPage}">末页</a></li>
