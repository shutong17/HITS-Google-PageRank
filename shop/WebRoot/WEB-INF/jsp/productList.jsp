...
<div class="container productList">
	...
	<div class="pagination">
		...
		<s:if test="cid!=null&&csid==null">
			<a href="${pageContext.request.contextPath }/product_findByCid.action?page=1&cid=<s:property value="cid" />" class="firstPage">&nbsp;</a>
			<s:if test="pageBean.page!=1">
			<a href="${pageContext.request.contextPath }/product_findByCid.action?page=<s:property value="pageBean.page-1" />&cid=<s:property value="cid" />" class="previousPage">&nbsp;</a>
			</s:if>
		...
		<s:if test="csid!=null&&cid==null">
			<a href="${pageContext.request.contextPath }/product_findByCsid.action?page=1&csid=<s:property value="csid" />" class="firstPage">&nbsp;</a>
			<s:if test="pageBean.page!=1">
			<a href="${pageContext.request.contextPath }/product_findByCsid.action?page=<s:property value="pageBean.page-1" />&cid=<s:property value="csid" />" class="previousPage">&nbsp;</a>
			</s:if>
			<s:iterator var="i" begin="1" end="pageBean.totalPage">
				<s:if test="pageBean.page==#i">
					<span class="currentPage"><s:property value="#i" /></span>
				...
				<s:else>
					<a href="${pageContext.request.contextPath }/product_findByCsid.action?page=<s:property value="#i" />&csid=<s:property value="csid" />"><s:property value="#i" /></a>
				</s:else>
			</s:iterator>
			<s:if test="pageBean.page!=pageBean.totalPage">
