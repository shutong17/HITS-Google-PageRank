	...
	<div class="span5">
		<div class="logo">
			<a href="${pageContext.request.contextPath}/网上商城/index.htm">
				<img src="${pageContext.request.contextPath}/${pageContext.request.contextPath}/image/renleipic_01/logo.gif" alt="传智播客"/>
			</a>
		</div>
	</div>
	<div class="span9">
				...
				<ul >
					...
					<s:iterator var="order" value="pageBean.list">
						<table>
							<tbody>
							<tr>
							<th width="77%"> 订单编号：<s:property value="#order.oid"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
							订单状态 ：
								<s:if test="#order.state==1">
									<a href="${pageContext.request.contextPath}/order_findByOid?oid=<s:property value="#order.oid"/>"><font color="red">未付款</font></a>
								</s:if>
								<s:if test="#order.state==2">
									<font color="yellow">已经付款</font>
								</s:if>
								<s:if test="#order.state==3">
									<a href="${pageContext.request.contextPath}/order_updateState?oid=<s:property value="#order.oid"/>"><font color="blue">准备收货</font> </a>
								</s:if>
								<s:if test="#order.state==4">
									<font color="green">交易完成</font>
								</s:if>
							</th>
							<th>订单总额：<s:property value="#order.total"/>
							</th>
						</tr>
						</tbody>
						</table>
...
<div class="container footer">
	<div class="span24">
		<div class="footerAd">
			<img src="${pageContext.request.contextPath}/image/renleipic_01/footer.jpg" alt="我们的优势" title="我们的优势" height="52" width="950" />
		</div>
	</div>
	<div class="span24">
		<ul class="bottomNav">
